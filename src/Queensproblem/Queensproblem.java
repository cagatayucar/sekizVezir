...
public class Queensproblem {
    ...
    public static void main(String[] args) {
		...
		while (climb) {
			...
			board.printBoard();
			System.out.println("# Birbirlerine saldıran vezir çiftleri: "
					+ board.h() + "\n");
			...
			for (int j = 0; j < board.board.length; j++) {
				System.out.println("Sütun içinden yineleme " + j + ":");
				best = false;
				...
				if (best) {
					...
					System.out.println("En iyi çözüm bu iterasyon ile bulundu: ");
					board.printBoard();
					System.out
							.println("# birbirlerine saldırı tehtidi oluşturan vezir çiftleri: "
									+ board.h() + "\n");
				} else {
